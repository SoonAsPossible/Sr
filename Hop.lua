...
--> Proxies (Apis)
local Proxies = {
    [1] = "https://games.robloxproxy.com/v1/games/85896571713843/servers/Public?sortOrder=Asc&limit=100&cursor=",
    [2] = "https://rbxproxy-lite.vercel.app/games/v1/games/85896571713843/servers/Public?sortOrder=Asc&limit=100&cursor=",
}
...
local CreateServerList = function() 
    ...
    repeat task.wait(5)
        ...
        print(`| 📝 JSON character count - { typeof(Request) == "string" and #Request or "DID NOT RECEIVE STRING?" }`)
...
local TeleportToServer = function() 
    ...
    if Servers then 
        ...
        repeat task.wait()
            ...
            if Servers and not Joined[Servers.id] then 
                ChosenServer = Chosen
            end
        until ChosenServer
